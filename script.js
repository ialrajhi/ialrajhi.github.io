...
const translations = {
  ...
  ar: {
    ...
    heroText: 'أنا فيصل الراجحي، صانع محتوى ومراجع تقني من الكويت. أقدم محتوى عربي عن الهواتف، الأجهزة، أدوات الذكاء الاصطناعي، الكاميرات، الألعاب، وأدوات صناعة المحتوى — بطريقة سهلة، عملية، وممتعة.',
    ...
    footerText: 'فيصل الراجحي. صانع محتوى تقني ومستكشف AI.', backTop: 'الرجوع للأعلى ↑'
  }
};
